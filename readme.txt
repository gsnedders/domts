...
the tests in the current DOMTS suites, as of February 2004: level1/core, html;
level2/core, html, events; level3/core, ls, events, validation, xpath).

How to get it running:

1. Download the DOM Test Suite. At the time of writing, the package at
   http://www.w3.org/DOM/Test/ is pretty ancient; better to grab a snapshot
   from the CVS project DOM-Test-Suite at dev.w3.org (username anonymous).
...
(thanks a lot Debian), you can specify an alternative using the command-line
option --workdom=name. Names are as above, but don't bother trying cDomlette,
FtMiniDom or microdom - they don't support enough of the DOM to work with.
